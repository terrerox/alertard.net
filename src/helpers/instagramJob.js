...
export const getInstagramPosts = async() => {
  ...
  const DEFAULT_URL = `https://graph.facebook.com/v14.0/17841447626729128?fields=media%7Bcaption%2Cmedia_type%2Cmedia_url%2Ctimestamp%2C%20thumbnail_url%7D&access_token=${import.meta.env.VITE_ALERTA_RD_ACCESS_TOKEN}`
  while (nextPageExist) {
